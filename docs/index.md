...
| 38 | **番茄小说** | 短剧视频 | ✅ 支持 | 🟢 免配置 | H5 推广页提取 + 官网播放器完整分集置换 | [查看指南](parsers/fanqie.md) |
| 39 | **红果短剧** | 短剧视频 | ✅ 支持 | 🟢 免配置 | H5 推广页提取 + 官网播放器完整分集置换 | [查看指南](parsers/fanqie.md) |
| 40 | **红果漫剧** | 漫剧/短剧视频 | ✅ 支持 | 🟢 免配置 | H5 推广页提取 + 官网播放器完整分集置换 | [查看指南](parsers/fanqie.md) |
